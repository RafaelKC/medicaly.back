...
namespace Medicaly.Infrastructure.Migrations
{
    ...
    [Migration("20240528015454_Ajustesd")]
    partial class Ajustesd
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Medicaly.Domain.Procedimentos.Procedimento", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Medicaly.Domain.Procedimentos.Procedimento", b =>
                {
                    ...
                    b.HasOne("Medicaly.Domain.UnidadesAtendimentos.UnidadeAtendimento", "UnidadeAtendimento")
                        .WithMany()
            ...
            modelBuilder.Entity("Medicaly.Domain.Resultados.Resultado", b =>
                {
                    b.HasOne("Medicaly.Domain.Procedimentos.Procedimento", null)
                        .WithOne()
                        .HasForeignKey("Medicaly.Domain.Resultados.Resultado", "ProcedimentoId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
